document.addEventListener("DOMContentLoaded", function() {
    ...
    agregarCarritoButtons.forEach(button => {
        button.addEventListener('click', () => {
            const productoId = button.parentNode.querySelector('p:first-of-type').textContent; // Use product name as unique ID
            const productoNombre = button.parentNode.querySelector('p:first-of-type').textContent;
